...
export default function page() {
    return (
        <div className='relative flex flex-col items-center justify-center min-h-screen w-full bg-[#0a0a0a] p-4 sm:p-6 overflow-hidden'>
            ...
            <div className="relative z-10 bg-white sm:bg-black rounded-2xl overflow-hidden shadow-[0_0_80px_20px_rgba(52,211,153,0.15)] w-full max-w-[560px] ring-1 ring-white/10">
