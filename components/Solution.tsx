            ...
            <div className="mx-auto max-w-[1200px]">
                ...
                <div className="grid grid-cols-1 gap-16 items-center lg:grid-cols-2 lg:gap-24">
                    ...
                    <div>
                        ...
                        <h2 className="reveal d1 mb-6 font-syne text-[clamp(2rem,4.5vw,3.5rem)] leading-[1.1]">
                            The guidance system medicine has always{' '}
                            <em className="font-instrument italic text-emerald-400">
                                needed.
                            </em>
                        </h2>
                    ...
                    <div className="reveal-right d2 group relative w-full">
                        <div className="relative h-[300px] lg:h-[420px]">
                            ...
                            {/* Card 1 (sc1) */}
                            <div className="absolute bottom-0 left-0 w-[85%] -rotate-2 rounded-[var(--radius-2xl)] border border-white/10 bg-[var(--ink)] p-[1.8rem] transition-transform duration-300 ease-[var(--ease-out)] group-hover:-rotate-3 group-hover:translate-y-1">
                                <div className="mb-4 flex items-center gap-[10px]">
                                    <div
                                        className="flex h-[38px] w-[38px] items-center justify-center rounded-full text-[0.8rem] font-semibold"
                                        style={{ background: 'linear-gradient(135deg,var(--pulse),var(--sage))' }}
                                    >
                                        DK
                                    </div>
                                    <div>
                                        <div className="font-syne text-[0.85rem] font-semibold">
                                            Dr. Khalid, MD
                                        </div>
                            ...
                            {/* Card 2 (sc2) */}
                            <div className="absolute left-[30px] top-[40px] z-10 w-[85%] rotate-1 rounded-[var(--radius-2xl)] border border-white/10 bg-[var(--ink)] p-[1.8rem] transition-transform duration-300 ease-[var(--ease-out)] group-hover:rotate-2 group-hover:-translate-y-1">
                                <div className="mb-4 flex items-center gap-[10px]">
                                    <div
                                        className="flex h-[38px] w-[38px] items-center justify-center rounded-full text-[0.8rem] font-semibold"
                                        style={{ background: 'linear-gradient(135deg,#059669,var(--sage))' }}
                                    >
                                        SR
                                    </div>
                                    <div>
                            ...
                            {/* Card 3 (sc3) */}
                            <div className="absolute right-0 top-0 z-20 w-[75%] rounded-[var(--radius-2xl)] border border-white/10 bg-[var(--ink)] p-[1.8rem] transition-transform duration-300 ease-[var(--ease-out)]">
                                <div className="mb-4 flex items-center gap-[10px]">
                                    <div
                                        className="flex h-[38px] w-[38px] items-center justify-center rounded-full text-[0.8rem] font-semibold"
                                        style={{ background: 'linear-gradient(135deg,var(--sage),#6ee7b7)' }}
                                    >
                                        JA
                                    </div>
                                    <div>
